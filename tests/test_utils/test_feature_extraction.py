...
#     extractor.raw_key_data = [
#         KeyStrokeEvent(16, "press", 1.0, 1.0, "Shift"),          # Shift press
#         KeyStrokeEvent(82, "press", 1.1, 1.1, "r"),     # R press
#         KeyStrokeEvent(82, "release", 1.3, 1.3, "r"),   # R release
#         KeyStrokeEvent(16, "release", 1.35, 1.35, "Shift"),      # Shift release
#     ]
#
#     extractor.extract_key_features()
#
#     assert "H.Shift.r" in extractor.key_features.features
#     assert extractor.key_features.get_key("H.Shift.r") == pytest.approx(0.2)
